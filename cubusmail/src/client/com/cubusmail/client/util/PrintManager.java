...
public abstract class PrintManager {
	...
	private static StringBuffer generateMessageHeader( GWTMessage message ) {
		...
		result.append( "<title>" );
		result.append( GWTUtil.htmlEncode( message.getSubject() ) );
		result.append( "</title>" );
		...
		if ( GWTUtil.hasText( message.getFrom() ) ) {
			...
			result.append( GWTUtil.htmlEncode( message.getFrom() ) );
			result.append( "</td></tr>" );
		}
		if ( GWTUtil.hasText( message.getTo() ) ) {
			...
			result.append( "</td><td class=\"printcontentname\">" );
			result.append( GWTUtil.htmlEncode( message.getTo() ) );
			result.append( "</td></tr>" );
		}
		if ( GWTUtil.hasText( message.getCc() ) ) {
			...
			result.append( "</td><td class=\"printcontentname\">" );
			result.append( GWTUtil.htmlEncode( message.getCc() ) );
			result.append( "</td></tr>" );
		}
		if ( GWTUtil.hasText( message.getReplyTo() ) ) {
			...
			result.append( "</td><td class=\"printcontentname\">" );
			result.append( GWTUtil.htmlEncode( message.getReplyTo() ) );
			result.append( "</td></tr>" );
		}
