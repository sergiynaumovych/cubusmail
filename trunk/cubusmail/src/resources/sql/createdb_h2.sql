...
CREATE INDEX INDEX_ADDRESSES1 ON ADDRESSES(FIRSTNAME);
CREATE INDEX INDEX_ADDRESSES2 ON ADDRESSES(LASTNAME);
CREATE INDEX INDEX_ADDRESSES3 ON ADDRESSES(EMAIL);
CREATE INDEX INDEX_ADDRESSES4 ON ADDRESSES(EMAIL2);
CREATE INDEX INDEX_ADDRESSES5 ON ADDRESSES(EMAIL3);
CREATE INDEX INDEX_ADDRESSES6 ON ADDRESSES(EMAIL4);
CREATE INDEX INDEX_ADDRESSES7 ON ADDRESSES(EMAIL5);
CREATE INDEX INDEX_ADDRESSES8 ON ADDRESSES(DISPLAYNAME);
