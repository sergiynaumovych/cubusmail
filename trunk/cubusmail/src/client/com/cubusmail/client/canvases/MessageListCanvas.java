...
public class MessageListCanvas extends SectionStack {
	...
	private ListGridField[] generateFields() {
		...
		// read flag
		fields[0] = new ListGridField( "read", "", 25 );
		...
		// attachment flag
		fields[1] = new ListGridField( "attachment", "", 25 );
		...
		// priority flag
		fields[2] = new ListGridField( "priority", TextProvider.get().grid_messages_subject(), 25 );
		...
		// subject
		fields[3] = new ListGridField( "subject", TextProvider.get().grid_messages_subject(), 500 );

		// from
		fields[4] = new ListGridField( "from", TextProvider.get().grid_messages_from(), 200 );

		// send date
		fields[5] = new ListGridField( "sendDate", TextProvider.get().grid_messages_date(), 120 );

		// size
		fields[6] = new ListGridField( "size", TextProvider.get().grid_messages_size(), 120 );
